# Data Analytics Portfolio – Anna Liza Orzechowska

This repository contains a selection of my data analytics projects in Python, R and BI tools.
They cover marketing analytics, customer loyalty (NPS), credit risk, and university projects from my Statistics & Data Analysis degree at the University of Vienna.

## 🔹 Tech Stack

- **Languages:** Python, R, SQL, Julia
- **Analytics & Modeling:** pandas, NumPy, statistics, regression, time series
...
2. **Market Analysis for Opening a Robot-Assisted Café in Moscow**  
   *Python, Pandas, NumPy, Seaborn, Matplotlib, Jupyter Notebook/Cursor*  
   A full exploratory analysis of the Moscow food service market based on open data.  
   The project includes extensive preprocessing, cleaning, address parsing, enriching with geographic information, and detailed statistical exploration.  
   We analyze seating capacities across object types, study chain vs. non-chain behavior, identify top streets and districts by concentration of establishments, and investigate
...
5. **Apartment Listings Market Analysis**  
   *Python, pandas, numpy, matplotlib, seaborn, Jupyter Notebook/Cursor*  
